    ...
    <div style="margin-top: 100px">
        @if ($user->following->isNotEmpty())
            <div class="row justify-content-center">
                <div class="col-4">
                    <h1 class="text-muted text-center">Following</h1>
                    ...
                    <div class="row align-items-center mt-3">
                        ...
                        @if ($following->following->id != Auth::user()->id)
                            ...
                            @else
                                <form action="{{route('follow.store' ,$following->follow->id)}}" method="post">
                                    @csrf
        ...
        @else
            <h3 class="text-secodary text-center">No Following</h3>
        @endif
    </div>
@endsection