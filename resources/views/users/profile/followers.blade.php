    ...
    <div style="margin-top: 100px">
        @if ($user->followers->isNotEmpty())
            <div class="row justify-content-center">
                <div class="col-4">
                    <h1 class="text-muted text-center">Followers</h1>
                    ...
                    <div class="row align-items-center mt-3">
                        ...
                        @if ($follower->follower->id != Auth::user()->id)
                            ...
                            @else
                                <form action="{{route('follow.store' ,$follower->follow->id)}}" method="post">
                                    @csrf
        ...
        @else
            <h3 class="text-secodary text-center">No Followers</h3>
        @endif
    </div>
@endsection