...
<div class="row border shadow">
        ...
        <div class="card border-0">
            <div class="card-header bg-white py-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        {{-- if you are the owner of the post, you can edit or delete this past --}}
                        ...
                        @else
                        {{-- if you are not the owner of the past, show a follow/unfollow button.
                        ...
                        @else
                           <form action="{{route('follow.store', $post->user->id)}}" method="post">
                                @csrf
                                <button style="submit" class="border-0 bg-transparent p-0 text-primary">Follow</button>
                            </form>
                        @endif
    ...
    {{-- strtotime('2025-07-12 11:57:31') --}}
    {{-- date('D, M D Y', 17123456789) --}}
    {{-- tue, jul 12 2025 --}}
                            ...
                            @foreach ($post->comments as $comment)
                                <div class="list-group-item border-0 p-0 mb-2">
                                    ...
                                    <form action="{{route('comment.destroy', $comment->id)}}" method="post">
                                        ...
                                        <span class="text-uppercase text-muted xsmall">{{'M d,Y', strtotime($comment->created_at)}}</span>
