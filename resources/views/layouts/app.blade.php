...
<head>
    ...
    {{-- Custom CSS --}}
    <link rel="stylesheet" href="{{ asset('css/style.css') }}"> {{-- public/... --}}
        ...
        <main class="py-5">
            <div class="container">
                <div class="row justify-content-center">
                    {{-- Admin Menu (col-3) --}}
                    @if (request()->is('admin/*'))
                    {{-- The is() allows you to verify the incoming request path(URL) matches a given pattern.
                        * is wildcard which means 'anything'
                    --}}
                        <div class="col-3">
                            <div class="list-group">
                                ...
                                <a href="{{route('admin.posts')}}" class="list-group-item {{request()->is('admin/posts')? 'active' :''}}">
                                    <i class="fa-solid newspaper"></i>Posts
                                </a>
